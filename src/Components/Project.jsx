...
import projectImgae1 from "../assets/spotify.png";
import projectImgae2 from "../assets/joke.png";
import projectImgae3 from "../assets/chat.png";
import projectImgae4 from "../assets/realestate.jpg";
...
const Project = () => {
  return (
    <section
      id="projects"
      className="h-auto flex flex-col bg-[#07374a] text-[#07374a] "
    >
      <TechnicalSkill />
      ...
      <div className="flex flex-col items-center  md:flex-row ">
        {/* 1st card */}
        <div className="bg-[#25b79f]  flex flex-col w-[95%] h-auto rounded-2xl m-4 p-8 ">
